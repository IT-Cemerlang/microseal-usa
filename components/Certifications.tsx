...
const Certifications: React.FC = () => {
  ...
  const downloadTechnicalPDF = async () => {
    ...
    try {
      ...
      drawDataRow(t("Nama Produk", "Product Name"), "Microseal™ Nano-Bond Pro Gen-3");
      ...
      drawDataRow(t("Massa Jenis", "Specific Gravity"), "1.02 @ 25°C");
      ...
      drawDataRow(t("Beton / Semen", "Concrete / Cement"), "8 - 12 m²/Liter");
      drawDataRow(t("Batu Alam / Bata", "Natural Stone / Brick"), "6 - 10 m²/Liter");
      drawDataRow(t("Kayu Berpori", "Porous Wood"), "10 - 14 m²/Liter");
      ...
      doc.text("Generated by Microseal Intelligent Engine • © 2024 Microseal Technologies Inc.", 105, 282, { align: "center" });
